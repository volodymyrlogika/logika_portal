...
class Workshop(models.Model):
    ...
    theme = models.ForeignKey(
        ...
        related_name='workshops', verbose_name='Тема'
    )
    is_published = models.BooleanField('Опубліковано', default=True)
    created_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True,
        related_name='created_workshops', verbose_name='Створив'
    )
...
class GalleryItem(models.Model):
    ...
    uploader = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, blank=True,
        related_name='gallery_uploads', verbose_name='Завантажив'
    )
    workshop = models.ForeignKey(
        Workshop, on_delete=models.SET_NULL, null=True, blank=True,
        related_name='gallery_items', verbose_name='Воркшоп'
    )
    theme = models.ForeignKey(
        Theme, on_delete=models.SET_NULL, null=True, blank=True,
        related_name='gallery_items', verbose_name='Тема'
    )
